...
*/
static OSStatus
S_Callback(void *inRefCon, AudioUnitRenderActionFlags *ioActionFlags, const AudioTimeStamp *inTimeStamp,
...
SNDDMA_Init(void)
{
	...
	dma.buffer = (qbyte *)s_mixedSamples;
