...
static void SV_Netchan_Encode( client_t *client, msg_t *msg ) {
	...
	string = (qbyte *)client->lastClientCommandString;
	index = 0;
...
static void SV_Netchan_Decode( client_t *client, msg_t *msg ) {
	...
	string = (qbyte *)client->reliableCommands[ reliableAcknowledge & (MAX_RELIABLE_COMMANDS-1) ];
	index = 0;
	//
...
void SV_Netchan_Transmit( client_t *client, msg_t *msg) {	//int length, const qbyte *data ) {
